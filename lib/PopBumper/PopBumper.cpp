...
{
    if(isTriggered() && triggeredFlag == false)
    {
    ...
    else if(triggeredFlag == true && currTime > timeTriggered + Constants::DELAY_TIME + Constants::POP_TIME + Constants::HOLD_TIME) //release pop bumper
    {
